...
int main(int, char**)
{
	...
	::RegisterClassEx(&wc);
	HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("booget external"), WS_EX_TOPMOST | WS_OVERLAPPEDWINDOW, 0, 0, 50, 50, NULL, NULL, wc.hInstance, NULL);
    ...
    bool done = false;
    auto updateThread = std::thread(recoil::legitware);
